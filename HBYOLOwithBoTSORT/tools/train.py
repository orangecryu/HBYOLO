...
wandb.init(project="BOTSORT-tools-VISO", entity="chaoran-yu")
...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default='D:/ycr/proj/BoT-SORT-main/tools/weights/yolov7.pt', help='initial weights path')
    # D:/ycr/proj/BoT-SORT-main/tools/weights/yolov7.pt
    parser.add_argument('--cfg', type=str, default='D:/ycr/proj/BoT-SORT-main/tools/cfg/yolov7-transformer-Improved/yolov7-transBoT3-HorNet.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='D:/ycr/proj/BoT-SORT-main/yolov7/data/VISO.yaml', help='dataset.yaml path')
    parser.add_argument('--hyp', type=str, default='D:/ycr/proj/BoT-SORT-main/tools/hyps/hyp.scratch-low.yaml', help='hyperparameters path')
