...
from tools.utils.general import check_img_size, check_requirements, check_imshow, non_max_suppression, apply_classifier, \
...
def detect(save_img=False):
    ...
    # Load model
    device = select_device(opt.device)
    model = DetectMultiBackend(weights, device=device, dnn=opt.dnn, data=opt.data)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='D:/ycr/proj/BoT-SORT-main/tools/runs/train/exp14/weights/last.pt', help='model.pt path(s)')
    parser.add_argument('--source', type=str, default='D:/ycr/proj/BoT-SORT-main/datasets/VISO/detect/test1/', help='source')  # file/folder, 0 for webcam
